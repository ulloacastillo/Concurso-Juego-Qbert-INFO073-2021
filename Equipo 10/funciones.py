...
def sndLoad(sndFolder):
    sonido = pygame.mixer.music.load(open(os.path.join(sys.path[0], sndFolder), "r"))
    return sonido
    
def compruebaPuntaje(puntajes,puntajeNuevo,nombre):
    print(puntajes)
    if puntajes[1] < puntajeNuevo:
        puntajes[5] = puntajes[3]
        puntajes[4] = puntajes[2]
        puntajes[3] = puntajes[1]
        puntajes[2] = puntajes[0]
        puntajes[1] = puntajeNuevo   
        puntajes[0] = nombre  
        print(puntajes)
        return puntajes
    if puntajes[3] < puntajeNuevo:
        puntajes[5] = puntajes[3]
        puntajes[4] = puntajes[2]
        puntajes[3] = puntajeNuevo 
        puntajes[2] = nombre 
        print(puntajes)     
        return puntajes
    if puntajes[5] < puntajeNuevo:
        puntajes[5] = puntajeNuevo 
        puntajes[4] = nombre
        print(puntajes)
        return puntajes
    return puntajes
